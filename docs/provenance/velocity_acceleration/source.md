...
# 来源依据 — velocity_acceleration

思想来源与公开先例（仅参考思想，未复制任何代码）：

- Finite-difference numerical differentiation (standard numerical methods).
- Internal MVP Spec v0.2.0, portability Tier 2 (normalizable).
