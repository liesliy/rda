...
STRINGS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "health_top_issues_header": "🔴 主要数据质量问题",
        "health_no_issues": "🎉 未发现明显的数据质量问题",
        "health_metric_critical": "🔴 严重 (Critical)",
        "health_metric_warning": "🟡 警告 (Warning)",
        "health_metric_types": "📋 问题类型数",
        ...
        "ep_queue_empty": "🎉 没有需要审核的 episode，数据集质量良好",
        "ep_queue_info": "共 **{n}** 个 episode 需要关注（{rm} 个 REMOVE（AI建议），{rv} 个 REVIEW）",
        ...
        "ep_verdict_exclude": "REMOVE · 建议排除",
        ...
        "ep_diag_why": "**WHY · 原因分析**",
        "ep_diag_next": "**NEXT · 处理建议**",
        ...
        "rec_caption": "基于数据集时间结构（idle 比例、active 段分布、有效窗口占比）生成保守的、带实验证据等级的优化建议。",
        ...
        "diag_disc_what": "动作不连续性异常偏高",
        "diag_disc_why": "可能是控制器抖动或传感器噪声",
        "diag_disc_next": "检查控制器参数或动作平滑处理",
        "diag_idle_what": "有效运动比例偏低",
        "diag_idle_why": "机器人可能长时间处于停顿或等待状态",
        "diag_idle_next": "检查是否为任务失败，考虑重采",
        ...
        "rec_action_discontinuity": "检查动作平滑度，可能需要调整控制器或加入动作滤波。",
        "rec_idle_ratio": "检查 episode 中是否存在长时间停顿，可能是任务失败或等待状态。",
    ...
    "en": {
        ...
        "health_top_issues_header": "🔴 Top Data Quality Issues",
        "health_no_issues": "🎉 No obvious data quality issues found",
        "health_metric_critical": "🔴 Critical",
        "health_metric_warning": "🟡 Warning",
        "health_metric_types": "📋 Issue types",
        ...
        "health_recommendation": "**Suggestion**",
        ...
        "ep_queue_empty": "🎉 No episodes need review — dataset quality is good",
        "ep_queue_info": "**{n}** episodes need attention ({rm} REMOVE (AI suggested), {rv} REVIEW)",
        ...
        "ep_verdict_exclude": "REMOVE · recommended to exclude",
        ...
        "ep_diag_why": "**WHY · Root cause**",
        "ep_diag_next": "**NEXT · Action**",
        ...
        "rec_caption": "Conservative, evidence-graded optimization advice based on temporal structure (idle ratio, active-run distribution, valid-window ratio).",
        ...
        "diag_disc_what": "Action discontinuity abnormally high",
        "diag_disc_why": "Possibly controller jitter or sensor noise",
        "diag_disc_next": "Check controller parameters or action smoothing",
        "diag_idle_what": "Effective motion ratio is low",
        "diag_idle_why": "The robot may be idle or waiting for extended periods",
        "diag_idle_next": "Check whether the task failed; consider re-recording",
        ...
        "rec_action_discontinuity": "Check action smoothness; controller tuning or action filtering may be needed.",
        "rec_idle_ratio": "Check whether episodes contain long pauses — possibly failed tasks or waiting states.",
